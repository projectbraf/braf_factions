...
class braf_hiaf_mp_helmet : braf_eb_ccb {
    ...
    hiddenSelectionsTextures[] = {
        "\braf\braf_factions\addons\headgear\data\ccb\hiaf\mb_hiaf_co.paa"
    };
...
class braf_hiaf_mp_helmet_goggles_up : braf_eb_ccb_goggles_up {
    ...
    hiddenSelectionsTextures[] = {
        "\braf\braf_factions\addons\headgear\data\ccb\hiaf\mb_hiaf_co.paa",
        "\braf\braf_factions\addons\headgear\data\goggles_nvg\goggles_large_CO.paa",
        "\braf\braf_factions\addons\headgear\data\goggles_nvg\glass_CA.paa"
    };
...
class braf_hiaf_army_helmet_cover : braf_eb_ccb_cover {
    ...
    hiddenSelectionsTextures[] = {
        "\braf\braf_factions\addons\headgear\data\ccb\hiaf\mb_hiaf_co.paa",
        "\braf\braf_factions\addons\headgear\data\ccb\hiaf\coifa_hiaf_army_co.paa"
    };
...
class braf_hiaf_marine_helmet_cover : braf_hiaf_army_helmet_cover {
    ...
    hiddenSelectionsTextures[] = {
        "\braf\braf_factions\addons\headgear\data\ccb\hiaf\mb_hiaf_co.paa",
        "\braf\braf_factions\addons\headgear\data\ccb\hiaf\coifa_hiaf_mariner_co.paa"
    };
    class ItemInfo : braf_ccb_cover_itemInfo {
        hiddenSelectionsTextures[] = {
            "\braf\braf_factions\addons\headgear\data\ccb\hiaf\mb_hiaf_co.paa",
