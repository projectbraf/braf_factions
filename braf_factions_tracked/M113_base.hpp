    ...
    class textureSources {
        class hiaf_01 {
            ...
            textures[] = {
                ...
                "braf_factions\braf_factions_tracked\data\m113\hiaf\accessories_hiaf_co.paa"
            };
        };
        class hiaf_02 {
            ...
            textures[] = {
                ...
                "braf_factions\braf_factions_tracked\data\M113\HIAF\accessories_marine_CO.paa"
            };
        };
        class usarmy_01 {
            displayName = "US Army";
            textures[] = {
                "braf_factions\braf_factions_tracked\data\M113\US\main_CO.paa",
                "braf_factions\braf_factions_tracked\data\M113\US\unique_CO.paa",
                "braf_factions\braf_factions_tracked\data\M113\US\accessories_CO.paa"
            };
        };
    };
};
...
class braf_factions_m577 : braf_army_m577 {
    ...
    class textureSources {
        class us_army_01 {
            displayName = "US Army";
            textures[] = {
                "braf_factions\braf_factions_tracked\data\m113\us\577_main_co.paa",
                "braf_factions\braf_factions_tracked\data\m113\us\main_co.paa",
                "braf_factions\braf_factions_tracked\data\m113\us\unique_co.paa"
            };
        };
